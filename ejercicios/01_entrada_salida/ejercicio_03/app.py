import tkinter # importamos la libreria/biblioteca tkinter
...
---
Enunciado:
Al presionar el botón  'Mostrar', se deberá obtener el contenido en la caja de texto y luego mostrarlo utilizando el Dialog Alert
'''
...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        saludo= 'Hola {0} {1}, trabajás en {2}.'.format(nombre, apellido, sector);
        alert( title = 'alert', message = saludo );
